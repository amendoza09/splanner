const Settings = ({ isOpen, onClose, groupCode, onLogout }) => {
    ...
    return(
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center w-screen px-[2rem] justify-center z-50">
        <div className="bg-white rounded-lg px-10  w-[380px] md:w-[500px] relative justify-center py-5 flex flex-col">
